...
public class FileBasic {
	...
	public static void main(String[] args) {
		...
		// proj 내의 파일목록 출력
		// .listFiles()
		// 해당 File 객체의 폴더의 파일 목록을 배열(Array)로 리턴
		...
		File ramen = new File(path + "/src/ch_10_extends_interface/ramen/Ramen.java");
		...
		// 폴더 만들기
		File today = new File("/home/pc08/today");
		...
		// 파일 만들기
		// /home/pc08/today 안에 test.txt 파일 만들기
		File test = new File("/home/pc08/today/test.txt");
		...
		String[] stuArray = {"유정", "준호", "동욱", "현진", "민경",
				"진영", "대일", "창연", "자영", "성복", "민기", "동윤", "지혜", "태윤", "준하"};

		// today 폴더 안에 위 학생들의 폴도를 각각 만들어주세요
		
		
		for(int i = 0; i < stuArray.length; i++) {
			File name = new File("/home/pc08/today/"+ stuArray[i]);
			name.mkdir();
		}

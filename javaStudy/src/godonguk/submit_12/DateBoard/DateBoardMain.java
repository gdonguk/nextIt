package godonguk.submit_12.DateBoard;
...
public class DateBoardMain {
	...
	public static void main(String[] args) throws ParseException {
		 ...
		 * 
		 * @Override public int compare(DateBoard dbA, DateBoard dbB) { try { Date left
		 * = sdf.parse(dbA.getDate()); Date right = sdf.parse(dbB.getDate());
		 * 
		 * if(left.getTime() - right.getTime() < 0) { return -1; } } catch
		 * (ParseException e) { e.printStackTrace(); } return result; } });
		 */
		System.out.println("\n=========================================================\n");
...
//		cal.add(Calendar.DATE, -30);
		...
		int month =  1 - 1;// toMonth.get(Calendar.MONTH);

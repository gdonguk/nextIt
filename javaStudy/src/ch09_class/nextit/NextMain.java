...
public class NextMain {
	...
	public static void main(String[] args) {
		...
		// 생성자의 파라미터 순서에 유의해서필드 변수의 값을 넣는다.
		...
		NextStudent joonho = new NextStudent("준호", 31, 1, 0);
		NextStudent kyeonho = new NextStudent("경호", 28, 1, 0);

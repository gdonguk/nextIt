...
public class ExceptionMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 클래스, 해당 에러가 발생하면 catch 블록 내부가 실행
		...
		// 마우스 우클릭 - Surround With - try catch 출력
		try {
		...
		/*
		 * while(true) { System.out.println("행동을 선택해 주세요");
		 * System.out.println("1. 밥먹기 | 2. 잠자기 | 3. 종료"); System.out.print(">>> ");
		 * 
		 * int command = 0; try { command = Integer.parseInt(scan.nextLine()); } catch
		 * (NumberFormatException e) { System.out.println("숫자만 입력해주세요!!"); continue; }
		 * 
		 * if(command == 1) { System.out.println("냠냠"); } else if(command == 2) {
		 * System.out.println("쿨쿨"); } else if(command ==3 ) { System.out.println("종료");
		 * break; } else { System.out.println("1,2,3 중 하나를 입력해주세요"); } }
		 */
		System.out.println("\n===========================================\n");

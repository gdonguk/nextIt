...
public class MethodMain {
	...
	public static void main(String[] args) {
		...
		// 리턴값이 존재하는 함수 만들기
		returnSum(80, 90); // 리턴값을 사용하고 있지 않
...
//		// LoopFor 에서 했던 각 자리수 더하기 메소드화
		...
		// LoopWhile 에서 했던 몬스터도 메소드로 만들어 버리기
//		playPokemon();
	...
	public static void recusionPrint(int num) {
...
//						break outer;
	...
	public static void makeCard(String name, int han, int eng, int math) {
		System.out.println("이름: " + name);
		System.out.println("국어: " + han);
		System.out.println("영어: " + eng);
		double avg = (han + eng + math) / 3.0;
		System.out.println("수학: " + math);

		// 반올림
		// 89.6666666 -> 90
		// 89.67
		double score = weRound(avg, 3);

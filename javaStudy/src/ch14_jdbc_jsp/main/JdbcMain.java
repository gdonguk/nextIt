...
import ch14_jdbc_jsp.service.StudentSurvice;
...
public class JdbcMain {
	...
	public static void main(String[] args) {
		StudentSurvice stuService = StudentSurvice.getInstance();
		System.out.println("\n" + 
				" _   __                            ______         _____        \n" + 
				"| | / /                            | ___ \\       |  __ \\       \n" + 
		...
		System.out.println("데이터 불러오는중..");

		WordGameService wordService = WordGameService.getIstance();
